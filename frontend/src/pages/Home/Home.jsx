...
const Home = () => {
    ...
    const donationTypes = {
        ...
        'platelets': {
            ...
            howOften: 'You can typically donate platelets every 2-7 days, with a maximum of 24 times per year.',
            howItWorks: 'We collect your blood, keep platelet and return rest to you by apheresis donation.',
            howLongDetailed: '45-60 minutes to donate. 2-3 hours for pre-donation screening.',
            image: '/platelets.jpg'
        }
    };
    ...
    return (
        <>
                ...
                <div className="hero-content">
                    <div className="hero-text">
                        ...
                        <p className="hero-subheading">
                            ...
                            LifeBridge helps you find the right blood type quickly when every minute counts.
                        </p>
            ...
            <hr className="my-20 " style={{
                visibility: "hidden",
                margin: "2rem"
            }} />

            <div className="section card-Main container mw-7xl">
                <h2 className="section-heading md:text-4xl font-bold mb-10 service">Our Services</h2>
                <div className="cardSection flex flex-wrap justify-around gap-6">

                    <div className="card flex flex-col items-center  " onClick={() => handleCardClick('/Availability')} style={{ cursor: 'pointer' }} >
                        <img src="/BBA.png" alt="Blood Bank" className="card-1" />
                        <h3>Find Blood Banks</h3>
                    </div>

                    <div className="card flex flex-col items-center" onClick={() => handleCardClick('/')} style={{ cursor: 'pointer' }}>
                        <img src="/BBD.png" alt="Donate Blood" />
                        <h3>Blood Bank Directory</h3>
                    </div>

                    <div className="card flex flex-col items-center" onClick={() => handleCardClick('/Donate')} style={{ cursor: 'pointer' }}>
                    ...
                    <div className="section-content about-content">
                        <div className="about-text">
                            ...
                            <p className="about-description">
                                <strong>LifeBridge</strong> is a digital platform designed to connect people with verified blood banks, check real-time blood availability, and encourage voluntary blood donations. With a mission to make blood accessibility faster and easier.
                            </p>
                            <p className="about-description">
                                LifeBridge provides features such as locating the nearest blood centers, checking the availability of specific blood types. 
                            </p>
                        </div>
            ...
            <div className="section blood-group-section">
                <div className="section-container blood-container">
                    <h2 className="section-heading blood-heading">Blood Group Compatibility</h2>
                    ...
                    <div className="blood-content">
                        ...
                        <div className="blood-buttons">
                            ...
                            <div className="button-grid">
                                <button className={`blood-btn ${selectedBloodGroup === 'A+' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('A+')}>A+</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'A-' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('A-')}>A-</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'B+' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('B+')}>B+</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'B-' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('B-')}>B-</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'AB+' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('AB+')}>AB+</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'AB-' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('AB-')}>AB-</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'O+' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('O+')}>O+</button>
                                <button className={`blood-btn ${selectedBloodGroup === 'O-' ? 'active' : ''}`} onClick={() => handleBloodGroupClick('O-')}>O-</button>
                            </div>
                        </div>
                        ...
                        <div className="compatibility-box">
                            ...
                            <div className="compatibility-content">
                                <div className="compatibility-section">
                                    ...
                                    <p className="receiver-info">{selectedBloodGroup ? bloodCompatibility[selectedBloodGroup].canReceive.join(',') : 'Select a blood group'}</p>
                                </div>
                                
                                <div className="compatibility-section">
                                    <h4>Can Donate To:</h4>
                                    <p className="donor-info">{selectedBloodGroup ? bloodCompatibility[selectedBloodGroup].canDonate.join(', ') : 'Select a blood group'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="section flow-chart-section">
                <div className="section-container flow-container">
                    <h2 className="section-heading flow-heading">Blood Donation Process</h2>
                    <p className="flow-subtitle">Understanding why blood banks charge and how your donation helps save lives</p>
            ...
            <div className="section donation-types-section">
                <div className="section-container donation-container">
                    <h2 className="section-heading donation-heading">Types of Donation</h2>
                    <p className="donation-subtitle">
                        The average human body contains about five litres of blood, which is made of several cellular and non-cellular components such as Red blood cell, Platelet, and Plasma.
                    </p>
                    
                    <div className="donation-options">
                        <button 
                            className={`donation-option ${selectedDonationType === 'red-cells' ? 'active' : ''}`}
                            onClick={() => setSelectedDonationType('red-cells')}
                        >
                        ...
                        <button 
                            className={`donation-option ${selectedDonationType === 'plasma' ? 'active' : ''}`}
                        ...
                        <button 
                            className={`donation-option ${selectedDonationType === 'platelets' ? 'active' : ''}`}
                        ...
                        <div className="donation-details">
                            <div className="details-content">
                                    ...
                                    {selectedDonationType === 'platelets' && (
                                        <>
                                            ...
                                            <div className="detail-section">
                                                ...
                                                <p>{donationTypes[selectedDonationType].howLongDetailed}</p>
                                            </div>
                                        </>
                                    )}
                                </div>
                                ...
                                <div className="details-image">
                                    <img src={donationTypes[selectedDonationType].image} alt={donationTypes[selectedDonationType].title} />
                                </div>
                            </div>
                        </div>
                    )}
            ...
            <footer className="footer">
                <div className="footer-container">
                        ...
                        <div className="footer-links">
                            ...
                            <div className="footer-section">
                                ...
                                <ul>
                                    ...
                                    <li><a href="/Availability">Blood Availability</a></li>
                                    <li><a href="/Donate">Blood Donation</a></li>
                                </ul>
                            </div>
                            ...
                            <div className="footer-section">
                                <h4>Contact</h4>
                                <ul>
                                    <li><a href="mailto:contact.ashishchoudhari@gmail.com">contact.ashishchoudhari@gmail.com</a></li>
                                    <li><a href="mailto:yachinverma@gmail.com">yachinverma@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="footer-bottom ">
                        <p>© 2025 LifeBridge. Developed by Ashish Choudhari and Yachin Verma. For educational purposes only.</p>
                    </div>
                </div>
            </footer>
